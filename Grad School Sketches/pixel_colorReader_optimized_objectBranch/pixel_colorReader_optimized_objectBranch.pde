  ...
  if (masterImageObject != null) {
    ...
    if (widthDiff < 1 && heightDiff < 1) {
      ...
      if (smallerDiff > 0) {
        ...
        image(masterDrawToScreen, workspaceWidth/2, height/2, masterDrawToScreen.width * heightDiff, masterDrawToScreen.height * heightDiff);
      } else {
        //needs to be fit to width
        image(masterDrawToScreen, workspaceWidth/2, height/2, masterDrawToScreen.width * widthDiff, masterDrawToScreen.height * widthDiff);
      }
    } else if (widthDiff < 1) {
      //wider than window
      image(masterDrawToScreen, workspaceWidth/2, height/2, masterDrawToScreen.width * widthDiff, masterDrawToScreen.height * widthDiff);
      ...
      //if it fits already
      image(masterDrawToScreen, workspaceWidth/2, height/2);
    }
  }
